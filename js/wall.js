...
function Wall(overligger, underligger, vegg, omlegg) {
   ...
   function getOverligger() {
     return overligger;
   }

   function setOverligger(overligger) {
     this.overligger = overligger;
   }

   function getUnderligger() {
     return underligger;
   }

   function setUnderligger(underligger) {
     this.underligger = underligger;
   }

   function setInndelingsOmlegg(inndelingsOmlegg) {
     this.inndelingsOmlegg = inndelingsOmlegg;
   }
   ...
   function setAvstand(avstand) {
     this.avstand = avstand;
   }

   function getMinsteOmlegg() {
     return minsteOmlegg;
   }

   function setMinsteOmlegg(minsteOmlegg) {
     this.minsteOmlegg = minsteOmlegg;
   }
   */
}
